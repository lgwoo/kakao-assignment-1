...
## 제출 전 체크리스트
- [ ] README 작성 (기능 설명)
- [ ] 예외 상황(빈 입력, 데이터 없음)에서도 오류 없음
- [ ] 새로고침 후 데이터 유지 / 의도대로 초기화
- [ ] console.log·죽은 주석 제거, 명확한 네이밍, 중복 로직 함수화
- [ ] 크롬 콘솔 에러 0, E2E 흐름 직접 확인
- [ ] node_modules / .DS_Store / .venv / todos.db / .env.local 미포함
